...
function EditForm( {saveUserData,page,pageSize,searchText}) {
  ...
  const handleSave = () => {
    if (validateProfileForm()) {
      saveUserData(editUserData,page,pageSize,searchText);
    }
  };
  return (
    <Dialog
    ...
    >
      ...
      <DialogTitle id="draggable-dialog-title">
        <div className="formHead">
          ...
          <Icon className="closeIcon" onClick={closeModal}>
            close
          </Icon>
        </div>
      </DialogTitle>
      ...
      <DialogActions>
        <AlbaButton variant="danger" className="cancelBtn" onClick={closeModal}>
          Cancel
        </AlbaButton>
