...
export default function Navbar() {
  ...
  return (
    <AppBar position="static">
      <div className="__nav-items__wrapper">
        <Toolbar>
          <img className="__imdb-icon" src={imdbIcon} alt="logo" />
          <div className="__nav-item__menu" onClick={handleMenuClick}>
            <MenuIcon className="__menu__icon" />
            <Typography className="__menu__icon">Menu</Typography>
          </div>
          <NavbarMenu open={openMenu} handleClose={handleCloseMenu} />
          <div className="__nav__searchbar">
            <TextForm
          ...
          <img
            ...
            src="https://m.media-amazon.com/images/G/01/IMDbPro/images/IMDbPro_brand_logo_small._SL1280_FMpng_.png"
          />
          <div className="__nav-item__menu">
            <AddBoxIcon className="__menu__icon" />
            <Typography className="__menu__icon">WatchList</Typography>
          </div>
          <div className="__nav-item__text">
